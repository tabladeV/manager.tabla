...
const ZoomControls: React.FC<ZoomControlsProps> = ({ onZoomIn, onZoomOut, onFocusAll }) => {
    return (
        <div className="flex gap-1 absolute right-[5px] top-[5px] z-[2]">
            <button className="size-[40px] btn-primary" onClick={onZoomOut} title="Zoom Out">
            ...
            <button className="size-[40px] btn-primary" onClick={onFocusAll} title="Focus All Tables">
            ...
            <button className="size-[40px] btn-primary" onClick={onZoomIn} title="Zoom In">

  ...
  return (
    ...
    >
      <div className='flex items-center'>
        ...
        <div>
          <h3 className='text-blacktheme font-[600]'>
            {itemData.name}
          </h3>
          <div className='flex gap-3'>
            ...
            <div className='flex gap-1 items-center'>
              ...
              <p className='font-[600] text-[13px] text-subblack'>{itemData.occasion === "none" ? t('placeManagement.reservations.none'):itemData.occasion}</p>
            </div>

              ...
              <button
                ...
                className={`
                  ...
                  ${isSelected
                    ...
                    : 'border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-[#335A06] hover:text-[#335A06] dark:hover:border-[#88AB61] dark:hover:text-[#88AB61] bg-white dark:bg-gray-800'
                  }
                `}
              >
                {guests}
                        ...
                        className={`
                          ...
                          ${isPastTime
                            ...
                            : isSelected
                              ...
                              : 'bg-white text-gray-700 border-gray-200 hover:border-[#335A06] hover:text-[#335A06] dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:border-[#88AB61] dark:hover:text-[#88AB61]'
                          }
                        `}
                      >
                        {time}
    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-hidden overflow-y-auto">
        <div className="text-center mb-2">
          <div className="w-16 h-16 bg-[#335A06]/10 dark:bg-[#88AB61]/20 rounded-full flex items-center justify-center mx-auto mb-4 text-[#335A06] dark:text-[#88AB61]">
            {/* Lucide CheckCircle */}
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-2 space-y-4 border border-gray-100 dark:border-gray-700 mb-2">
      ...
      <div className=" border-gray-100 dark:border-gray-800 bg-white dark:bg-bgdarktheme shrink-0 z-10">
        <button
          onClick={onConfirmClick}
          className="w-full py-4 bg-[#335A06] hover:bg-[#2a4a05] text-white font-bold rounded-xl shadow-lg shadow-[#335A06]/20 transform transition-all hover:-translate-y-0.5 active:translate-y-0"
        >
